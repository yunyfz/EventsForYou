...
public class TicketMaster implements ExternalAPI{
	...
	private static final String API_KEY = "KL2kl9HI4SWyVtIEGCUfLI4ytlycAGvC";
	...
	public static void main(String[] args) {
		TicketMaster tmApi = new TicketMaster();
		// Mountain View, CA
